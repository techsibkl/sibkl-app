// MoveToStepAction.tsx

import { StepAction } from "@/services/Flow/flow.types";
import { ArrowRight, StepForwardIcon } from "lucide-react-native";
...
const MoveToStepAction = ({ action }: Props) => {
	return (
		<TouchableOpacity
			activeOpacity={0.7}
			onPress={() => {}}
		...
		>
			...
			<View className="flex-1">
				<Text className="text-gray-800 font-semibold">Move to step</Text>
