...
const store = createStore({
  state: {
    products: [
            {
    "id": "1",
    "title": "Phishing Notifications",
    "img":"https://www.vadesecure.com/hubfs/Email-Notifications_Phishing-for-Victims-in-Election-Year-1200x800.jpg",
    ...
    "longDescription": "Phishing Notifications can happen to anyone. One day, Alice, a diligent employee, received an email seemingly from her bank. The message stated there was suspicious activity on her account and requested her to click a link to verify her credentials. Alarmed, she clicked the link and entered her login information. Unbeknownst to her, it was a phishing Notification. The attackers gained access to her bank account and stole her savings. Alice's story serves as a stark reminder of how convincing phishing emails can be and how anyone can fall prey to them.",
    "count":7097,
    "identify": [
  ...
  {
    "id": "2",
    "title": "Tech Support Notifications",
    "img":"https://1.bp.blogspot.com/-Xm0IJFvXgsg/XM1blyo3I-I/AAAAAAAAEI8/B7BmCHzIPvwGTl72I9qt0PfkcngefbxZgCLcBGAs/s1600/tech-support-Notification.jpg",
    "description": "Notificationmers impersonate tech support representatives from reputable companies, claiming there's a problem with the victim's computer and demanding payment for fixing it.",
    "longDescription": "Tech support Notifications can victimize even the most cautious individuals. Sarah, a retiree, received a call from someone claiming to be a Microsoft support technician. They convinced her that her computer was infected with a virus and needed immediate repair. To resolve the issue, they demanded a substantial fee. Worried about her personal data, Sarah complied and paid the Notificationmers. Unfortunately, her computer was never infected, and she had fallen for a tech support Notification. Sarah's story highlights the need for verifying the authenticity of unsolicited tech support calls.",
    "count":6492,
    "identify": [
  ...
  {
    "id": "3",
    "title": "Online Shopping Notifications",
    "img":"https://australiancybersecuritymagazine.com.au/wp-content/uploads/2021/11/img_A-NotificationWatch-Alert.jpg",
  ...
  },
  {
    ...
    "longDescription": "Romance Notifications are a threat to anyone seeking love online. Rebecca, a single professional, met 'Alex' on a dating site. Over time, they developed a deep connection, and 'Alex' shared stories of financial hardship. Wanting to help, Rebecca sent 'Alex' a significant sum of money. However, 'Alex' was a fictitious character created by a romance Notificationmer. Rebecca's story is a heartbreaking example of how emotional vulnerability can be exploited in online Notifications.",
    "count":3108,
    "identify": [
  ...
  {
    "id": "5",
    "title": "Investment/Fake ICO Notifications",
    ...
    "longDescription": "Investment Notifications can ensnare even the most financially savvy individuals. James, an experienced cryptocurrency enthusiast, came across an ICO promising astronomical returns. Excited about the opportunity, he invested a substantial amount. However, the ICO was a Notification, and James lost his entire investment. His story underscores the importance of thorough research and due diligence in the world of cryptocurrency investments.",
    "count":2106,
    "identify": [
  ...
  {
    "id": "6",
    "title": "IRS or Tax Notifications",
    "img":"https://i2.cdn.turner.com/money/dam/assets/150122071202-dirty-dozen-irs-Notification-1-640x640.jpg",
    "description": "Notificationmers impersonate tax authorities and threaten victims with legal action or arrest if they don't pay alleged back taxes immediately.",
    "longDescription": "IRS Notifications can target anyone, regardless of their tax history. Kevin, a law-abiding citizen, received a call from someone claiming to be from the IRS. They asserted he owed back taxes and would face immediate legal consequences if he didn't pay. Panicked, Kevin complied and transferred a substantial sum. Later, he discovered it was an IRS Notification, and he had fallen victim to the fraud. Kevin's story underscores the importance of verifying tax-related calls with official sources.",
    "count":1696,
    "identify": [
  ...
  {
    "id": "7",
    "title": "Lottery or Prize Notifications",
        "img":"https://blog.avast.com/hubfs/lottery_Notifications.2.jpg",
    ...
    "longDescription": "Lottery Notifications can deceive anyone in pursuit of good fortune. Emily received an email stating she had won a luxury vacation in a lottery she never entered. To claim the prize, she was asked to pay a processing fee upfront. Eager for the vacation, Emily paid the fee but never received any prize. It was a lottery Notification, and Emily learned that legitimate lotteries never require upfront payments.",
    "count":1031,
    "identify": [
  ...
  {
    "id": "8",
    "title": "Social Engineering Notifications",
  ...
  {
    "id": "10",
    "title": "Job or Work-from-Home Notifications",
    "img":"https://media.kasperskydaily.com/wp-content/uploads/sites/102/2023/01/24000632/2023-job-Notifications-and-how-to-avoid-them-featured-1500x986.jpg",
    ...
    "longDescription": "Job Notifications can affect anyone searching for employment. Alex, a recent college graduate, was thrilled to find a job offer that promised substantial pay for working from home. However, the job required an upfront fee for training materials. Eager to kickstart his career, Alex paid the fee but never received any materials or heard from the company again. Alex had fallen for a job Notification, a stark reminder of the dangers of job offers that ask for upfront payments.",
    "count":626,
    "identify": [ 
